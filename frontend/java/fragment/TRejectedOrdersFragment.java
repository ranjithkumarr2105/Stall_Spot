...
public class TRejectedOrdersFragment extends Fragment {
    ...
    private void setupRecyclerView() {
        adapter = new OOrdersAdapter(null);
    ...
    private void fetchOrders() {
        ...
        ApiClient.getClient().create(ApiService.class).getOwnerOrders(stallId, "rejected")
                    ...
                    public void onResponse(@NonNull Call<OGetOrdersResponse> call, @NonNull Response<OGetOrdersResponse> response) {
                        ...
                        if (response.isSuccessful() && response.body() != null && "success".equals(response.body().getStatus())) {
                            if (response.body().getOrders() != null && !response.body().getOrders().isEmpty()) {
                                ...
                                emptyView.setText("No rejected orders found.");
